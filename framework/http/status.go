...
// StatusError marks a transport-driven rollback decision derived from an HTTP
// status code.
...
func (e *StatusError) Error() string {
	...
	return fmt.Sprintf("httpuow: rollback requested for HTTP status %d", e.StatusCode)
}
